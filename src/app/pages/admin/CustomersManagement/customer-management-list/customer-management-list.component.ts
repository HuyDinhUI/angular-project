...
export class CustomerManagementListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const sb = this.customerManagementService.isLoading$.subscribe((res:any) => (this.isLoading = res));
