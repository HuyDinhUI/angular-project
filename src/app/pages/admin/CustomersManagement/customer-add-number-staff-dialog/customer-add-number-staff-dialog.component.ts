...
import { GroupingState, IGroupingState, PaginatorState } from '../../../../_metronic/shared/crud-table';
...
export class CustomerAddNumberStaffDialogComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const sb = this.customerManagementService.isLoading$.subscribe((res:any) => {
      this.isLoading = res;
    })
