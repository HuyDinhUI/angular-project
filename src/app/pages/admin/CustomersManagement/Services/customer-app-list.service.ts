...
import { GroupingState, ITableState, PaginatorState, SortState, TableService } from '../../../../_metronic/shared/crud-table'

import { AppListDTO, CustomerAppAddNumberStaffModel, CustomerAppDTO, CustomerModel } from '../Model/customer-management.model';
...
@Injectable()
export class CustomerAppListService extends ITableService<AppListDTO[]> implements OnDestroy {
  ...
  constructor(@Inject(HttpClient) http:any, @Inject(HttpUtilService) httpUtils:any) {
