...
export class LayoutUtilsService {
	...
	// Method returns instance of MatDialog
	updateStatusForCustomers(title:any, statuses:any, messages:any) {
	...
	showWaitingDiv() {
		...
		let divWait:any = document.getElementById(v_idWaiting);
		let loader:any = document.getElementById(v_idWaitingLoader);
