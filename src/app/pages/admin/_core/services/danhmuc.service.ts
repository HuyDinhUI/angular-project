...
import { HttpUtilService } from '../utils/http-utils.service';
import { QueryParamsModel } from '../models/query-models/query-params.model';
import { QueryResultsModel } from '../models/query-models/query-result.model';
...
export class DanhMucChungService {
  ...
  constructor(private http: HttpClient, private httpUtils: HttpUtilService, public datepipe: DatePipe) { }
  ...
  isEqual(object:any, otherObject:any) {
