...
const API_PRODUCTS_URL =
  environment.ApiRoot + '/categorymanagement/typeassest';
...
@Injectable()
export class ListTypeAssestManagementService
  extends ITableService<TypeAssetDTOModel[]>
  implements OnDestroy
{
  ...
  public getListInsurance(): Observable<ResultModel<TypeAssetDTOModel>>{
