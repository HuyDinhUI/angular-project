...
const API_PRODUCTS_URL =
  environment.ApiRoot + '/categorymanagement/groupassest';
...
@Injectable()
export class ListGroupTypeAssestManagementService
  extends ITableService<GroupTypeAssestDTOModel[]>
  implements OnDestroy
{
  ...
  public getListGroupAssest(): Observable<ResultModel<GroupTypeAssestDTOModel>>{
