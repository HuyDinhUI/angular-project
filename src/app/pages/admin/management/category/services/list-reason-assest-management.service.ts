...
import { TypeAssetDTOModel } from '../model/list-type-assest-management.model';
import { GroupTypeAssestDTOModel } from '../model/list-group-type-management.model';
import { ReasonAssestDTOModel } from '../model/list-reason-assest-management.model';

const API_PRODUCTS_URL =
  environment.ApiRoot + '/categorymanagement/reasonassest';
...
@Injectable()
export class ListReasonAssestManagementService
  extends ITableService<ReasonAssestDTOModel[]>
  implements OnDestroy
{
  ...
  public getListReasonAssest(): Observable<ResultModel<ReasonAssestDTOModel>>{
